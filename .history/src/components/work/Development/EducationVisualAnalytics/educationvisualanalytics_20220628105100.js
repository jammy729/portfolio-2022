...
import { Box, Center, Container, List, ListItem, Text } from '@chakra-ui/react'
  ...
  return (
    <Box>
      <Container>
        ...
        <List>
          <ListItem>
            <Tag> Type </Tag> Analyzing Visualizations, Research Dataset, Dataset Cleaning
          </ListItem>
          <ListItem>
            <Tag> Stack </Tag> JavaScript D3JS (Visualization Library)
          </ListItem>
          <ListItem>
            <Tag> Source </Tag>   <a href="https://observablehq.com/@jamesyoo/iat-355-final-project-spring-2021/2">
