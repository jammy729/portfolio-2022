    ...
    <Box>
      <Container>
        ...
        <WorkImage
          ...
          w='full'
        />
        I have used histogram to discover the relationship between parental level
        of education and the student score on the writing, reading and math
        test. The histogram shows the median value of individual tests divided
        into sections of parental level of education. The interaction in this
        visualization is the ability to sort histogram from ascending to
        descending. This allows the user to easily identify the extremum and
        also sort the data cases.
      </Container>
    </Box>
  )
}
