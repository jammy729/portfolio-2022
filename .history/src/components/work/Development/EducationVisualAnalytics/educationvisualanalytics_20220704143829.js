  ...
  return (
    <Box>
      <Container>
        ...
        <WorkImage src={cover} alt='Observable Data Visualization Cover' w='full' />
        {/* BADGES  */}
        <List>
          <ListItem>
        ...
        <DescriptionText>
          ...
          dependent and independent variables relationship and what the chart
        ...
        <DescriptionText>
          ...
          <List>
            ...
            <WorkImage
              src={data4}
              alt='Histogram chart'
              caption='An interactive scattered plot graph that shows the relationship between parental income adn years to graduate colored by '
              w='full'
            />
          </List>
        </DescriptionText>
        ...
        <DescriptionText>
          ...
          learned a lot from this project as it was a solo work and a massive
          learning experience for me using a JavaScript library and
          understanding data visualization.
        </DescriptionText>
        <DescriptionText>
          One major struggle I had was writing the reasoning for the
          visualization data. When I look at the data chart that I have created,
          I have no problem understanding the visual and explaining it to myself
          the reasoning but wording them on a report was difficult. I spent more
          time on how to express my reasoning and communicate my visual to the
          audience than creating data visualization.
        </DescriptionText>
