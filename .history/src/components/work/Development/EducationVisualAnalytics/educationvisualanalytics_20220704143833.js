        ...
        <DescriptionText>
          ...
          <List>
            ...
            <WorkImage
              src={data4}
              alt='Histogram chart'
              caption='An interactive scattered plot graph that shows the relationship between parental income adn years to graduate colored by the parental level of education'
              w='full'
            />
          </List>
        </DescriptionText>
