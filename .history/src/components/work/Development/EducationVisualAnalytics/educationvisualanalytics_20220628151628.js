...
import { Box, Container, List, ListItem, OrderedList } from '@chakra-ui/react'
  ...
  return (
    <Box>
      <Container>
        ...
        <DescriptionText>
          I choose this data visualization because I was interested in how parental level of education
          and income can influence child performance in school and years to graduate. I have the amazing privilege of living in Canada
          and receive education as well as 
          In this data visualization, we are focusing on whether parental level
          of education and income can influence child performance in school and
          years to graduate.
        </DescriptionText>
        ...
        <DescriptionText>
          ...
          <OrderedList>
            ...
            <ListItem>
              How does parental income and level of education influence
              student’s years to graduate?
            </ListItem>
          </OrderedList>
        </DescriptionText>
      </Container>
