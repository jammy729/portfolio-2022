    ...
    <Box>
      <Container>
        ...
        <DescriptionText>
          ...
          Tableau (an interactive data visualization software), I went through
          many types of charts and visualize what kind of data could work to
          answer the domain questions.  Some examples are as below.
        </DescriptionText>
