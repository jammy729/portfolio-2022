  ...
  return (
    <Box>
      <Container>
        ...
        <DescriptionText>
          The interactivity in this is the ability for user to ascend or descend the orders in 
          which they prefer. Through this interactivity, we can see that higher the education, the median value of subject score is generally much higher
        </DescriptionText>
