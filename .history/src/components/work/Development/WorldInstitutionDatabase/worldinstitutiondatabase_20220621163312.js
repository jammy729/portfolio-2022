...
const WorldInstitutionDatabase = () => {
  ...
  return (
    <Box>
      <Container maxW='800px'>
        ...
        <List py={2}>
          ...
          <ListItem>
            <Tag> Source </Tag>
            <a target="blank" href='https://github.com/rubik516/iat352-institution-reviews-web-app'>
              Github Link
            </a>
          </ListItem>
        </List>
    ...
    '
        ...
        and have favourite lists of institutions. Therefore, there are two entities which are the 'Users' and 'Institution', 
        and two relationships between the two entities are the 'Comment' and 'Favourite'"
        />
      </Container>
    </Box>
  )
