  ...
  return (
    <Box>
      <Container maxW='800px'>
        ...
        description="Wanting the responsiveness in the login and registration form, I used Bootstrap (CSS Framework)
        to have the form responsive. Instead of inventing a unique form fields, I have used simple forms so user can 
        focus on the task to login or register to be a member"
        />
      </Container>
    </Box>
  )
