...
import { Writings, DescriptionText } from '../../layout'
  ...
  return (
    <Box>
      <Container maxW='850px'>
        ...
        <Divider />
        <Writings size='md' title='Summary'>
          <DescriptionText>
        ...
        <Writings size='md' title='Contribution'>
          <DescriptionText>
        ...
        <Writings size='md' title='Database Analysis'>
          <DescriptionText>
            {' '}
            description='I created an entity-relationship diagram (ER) diagram
            to illustrate how entities relate to each other in a system. This
            step was one of the most important steps because it is the
            foundation of modelling the data stored in the database and how the
            database is built.'
          </DescriptionText>
        </Writings>
