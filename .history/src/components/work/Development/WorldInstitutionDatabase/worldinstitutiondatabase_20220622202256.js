...
import { Container, Box, List, ListItem, Divider, Text } from '@chakra-ui/react'
  ...
  return (
    <Box>
      <Container maxW='800px'>
        ...
        <Text fontSize='lg' textAlign="justify"> My role in this project divided into two parts, the design of the
          Entity-Relationship diagram and schema table, and the frontend and
          backend development of the login and register form.</Text>
