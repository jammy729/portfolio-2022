    ...
    <Box>
      <Container maxW='800px'>
        ...
        <Writings
          ...
          description="Registration validation is supported and done using a jQuery Validation Plugin to
          check whether the forms are filled correctly following a set rules. To satisfy the requirement,
          a user must fill the username length between 5-25 characters, password lengths between 5-30 characters"
          />
