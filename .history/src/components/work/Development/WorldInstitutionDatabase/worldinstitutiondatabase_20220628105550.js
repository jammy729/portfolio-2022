    ...
    <Box>
      <Container maxW='850px'>
        ...
        <Writings
          size='md'
          title='Contribution'>
            <DescriptionText>         My role in this project divided into two parts, the design of the Entity-Relationship diagram and schema table, 
          and the frontend and backend development of the login and register form.</DescriptionText>
          </Writings>
