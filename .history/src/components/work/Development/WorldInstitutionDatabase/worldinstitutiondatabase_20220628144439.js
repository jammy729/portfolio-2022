    ...
    <Box>
      <Container maxW='850px'>
        ...
        <Writing size='md' title='Challenges'>
          <DescriptionText>
            This project was very challenging so the group
            naturally led the focus to the backend functionalities and less on
            the frontend. Looking back on the project, there are many frontend
            mistakes that should have been avoided such as not working on a
            design system and using a serif font instead of sans-serif because
            it reduces text visibility. Due to new languages introduced which
            were PHP, jQuery and SQL, my group struggled a little and we often
            found ourselves going back to lecture and lab tutorials and
            StackOverflow. Surprisingly, AJAX to update the frontend web page
            when the user filters and display favourite institutions were easier
            than expected and was executed as our expectations. 
          </DescriptionText>
        </Writing>
        <Divider />
        <Writing size='md' title='Reflection'>
          <DescriptionText>
            Through this project, I have seen myself grow as a
            developer in terms of collaboration with a member and good
            understanding of backend development. I have learned how to organize
            the project in terms of timeline to ensure my group meet the
            deadline and how to organize the file structure and write clean code
            to ensure that the group can easily understand the code and find
            files. If I could change one thing about this project, it would
            mainly be the frontend development. Because the group focused more
            on the backend development, we did not really put much effort in
            frontend design so it does not look good and responsive. Overall,
            this project was successful and achieved final grade of 93% for this
            project. I am currently redoing the frontend design as my own
            project to make better frontend experience using ReactJS as I do not
