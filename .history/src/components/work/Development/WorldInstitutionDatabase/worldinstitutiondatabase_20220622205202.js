  ...
  return (
    <Box>
      <Container maxW='800px'>
        ...
        registration form, I used Bootstrap (CSS Framework) to have the form responsive. Instead of inventing a unique form fields, I have used simple forms so user can 
