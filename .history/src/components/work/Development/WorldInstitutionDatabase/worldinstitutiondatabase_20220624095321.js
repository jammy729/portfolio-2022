  ...
  return (
    <Box>
      <Container maxW='800px'>
        ...
        the project, there are many frontend mistakes that should have been avoided such
        as inconsistent typeface across pages and UI designs of the components. Due to 
        new languages introduced which were PHP, jQuery and SQL, my group struggled a 
        little and we often found ourselves going back to lecture and lab tutorials and
        StackOverflow. Surprisingly, AJAX to update the frontend web page when the user
        filters and display favourite institutions were />
        <Divider />
