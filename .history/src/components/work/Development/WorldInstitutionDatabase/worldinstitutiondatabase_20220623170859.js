    ...
    <Box>
      <Container maxW='800px'>
        ...
        <Writings
          ...
          requirement, such all fields must be filled, a user must fill the username length between 
          5-25 characters, password lengths between 5-30  characters and othe "
          />
