  ...
  return (
    ...
    '
        ...
        <Writings
          ...
          a system. This step was one of the most important steps because it is the foundation of modelling the data stored in the database Entity-Relationship diagram is a chart ath illustrates how entities relate to each other in a system. I 
          
          Entity-Relationship diagram also referred to as ER diagram is important in Database Management System (DBMS) 
          ...
          the data that are needed for this project. I created a ER diagram that illustrates how entities relate to each other in a system.
