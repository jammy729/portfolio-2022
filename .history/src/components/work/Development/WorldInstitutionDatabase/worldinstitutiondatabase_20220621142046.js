...
const WorldInstitutionDatabase = () => {
  ...
  return (
    ...
    '
        ...
        description="This web application aims to provide a platform where current and alumni students can
        share their experiences at their institutions while prospective students can read the reviews. For the 
        sharing experiences, only the registered members can share experiences and have favourite list of institutions"
        />
      </Container>
    </Box>
  )
