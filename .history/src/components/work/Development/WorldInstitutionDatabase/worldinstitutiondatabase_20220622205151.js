  ...
  return (
    <Box>
      <Container maxW='800px'>
        ...
        and register page, I have decided to code with HTML, and CSS. Wanting the responsiveness in the login and registration form, I used Bootstrap (CSS Framework)
        to have the form responsive. Instead of inventing a unique form fields, I have used simple forms so user can 
        focus on the task to login or register so used "
        />
      </Container>
    </Box>
  )
