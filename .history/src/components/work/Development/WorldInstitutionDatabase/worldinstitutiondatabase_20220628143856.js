    ...
    <Box>
      <Container maxW='850px'>
        ...
        <Writing size='sm' title='Backend Development'>
          <DescriptionText>
            description='Once the user fill the form and satisfy the rules, it
            connects to MySQL database, and receive all the input value form
            from the user and check from the database whether the username or
            email value exists in the database because the username and email is
            a key value. Finally, if there is no error issues with the form, it
