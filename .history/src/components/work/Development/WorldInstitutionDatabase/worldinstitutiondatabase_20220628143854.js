      ...
      <Container maxW='850px'>
        ...
        <Writing
          ...
          title='Backend Development'>
            <DescriptionText>description='Once the user fill the form and satisfy the rules,
            ...
            information into the database with the encrypted password'</DescriptionText>
          </Writing>
