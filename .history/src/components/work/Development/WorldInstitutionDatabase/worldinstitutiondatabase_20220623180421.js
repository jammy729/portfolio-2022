...
import { Container, Box, List, ListItem, Divider, AspectRatio } from '@chakra-ui/react'
      ...
      <Container maxW='800px'>
        ...
        <Writings
          ...
          description='Once the user fill the form and satisfy the rules,
            ...
            algorithm (MD5) to secure from SQL injection and insert the user information into the database
